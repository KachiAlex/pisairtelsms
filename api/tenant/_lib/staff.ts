...
export async function ensureStaffTables(): Promise<void> {
  try {
    ...
    await sql`ALTER TABLE staff ADD COLUMN IF NOT EXISTS tenant_id TEXT NOT NULL DEFAULT 'default-tenant'`
    ...
    await sql`CREATE INDEX IF NOT EXISTS idx_staff_tenant_id ON staff(tenant_id)`
    ...
    `
    await sql`ALTER TABLE staff_leave ADD COLUMN IF NOT EXISTS tenant_id TEXT NOT NULL DEFAULT 'default-tenant'`
    ...
    await sql`CREATE INDEX IF NOT EXISTS idx_leave_tenant_id ON staff_leave(tenant_id)`
    ...
    `
    await sql`ALTER TABLE staff_attendance ADD COLUMN IF NOT EXISTS tenant_id TEXT NOT NULL DEFAULT 'default-tenant'`
    ...
    await sql`CREATE INDEX IF NOT EXISTS idx_attendance_tenant_id ON staff_attendance(tenant_id)`
    ...
    `
    await sql`ALTER TABLE staff_payroll ADD COLUMN IF NOT EXISTS tenant_id TEXT NOT NULL DEFAULT 'default-tenant'`
    ...
    await sql`CREATE INDEX IF NOT EXISTS idx_payroll_tenant_id ON staff_payroll(tenant_id)`
