...
import {
  ...
  updateClass,
  deleteClass,
} from '../cbt/_lib/classes.js'
import { initializeDatabase } from '../cbt/_lib/db.js'
import { auditAcademicChange } from '../_lib/academic-audit.js'

/**
 * Academic Structure Classes API
 * Re-exports CBT classes for use by the Academic Structure module so that
 * /api/tenant/academics/classes is the canonical academic-structure endpoint.
 */
