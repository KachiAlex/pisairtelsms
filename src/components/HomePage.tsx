    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center gap-6">
              ...
              <a href="#benefits" className="text-gray-700 hover:text-red-600 transition-colors">
                Benefits
              </a>
              ...
              <Button onClick={onNavigateToDashboard} className="bg-red-600 hover:bg-red-700">
                Access Dashboard
              </Button>
            </div>
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden border-t border-gray-200">
            <div className="px-4 py-3 space-y-3">
              <a href="#features" className="block text-gray-700 hover:text-red-600 py-2">
                Features
              </a>
              <a href="#benefits" className="block text-gray-700 hover:text-red-600 py-2">
                Benefits
              </a>
              <a href="#pricing" className="block text-gray-700 hover:text-red-600 py-2">
                Pricing
              </a>
              <a href="#contact" className="block text-gray-700 hover:text-red-600 py-2">
                Contact
              </a>
              <Button onClick={onNavigateToDashboard} className="w-full bg-red-600 hover:bg-red-700">
                Access Dashboard
              </Button>
            </div>
          </div>
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-amber-50 via-orange-50 to-rose-50">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <div className="absolute -bottom-20 left-1/2 w-80 h-80 bg-rose-200 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-pulse" style={{ animationDelay: '2s' }}></div>
        </div>

        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24 relative">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="relative z-10">
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/80 backdrop-blur-sm border border-red-200 text-red-700 rounded-full text-sm font-medium mb-6 shadow-sm">
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-8">
                <Button 
                  ...
                  size="lg" 
                  className="bg-gradient-to-r from-red-600 to-orange-500 hover:from-red-700 hover:to-orange-600 text-lg px-8 shadow-lg hover:shadow-xl transition-all"
                >
                  Get Started Free
            ...
            <div className="relative lg:h-[600px] flex items-center justify-center">
              ...
              <div className="relative w-full max-w-md mx-auto">
                <div className="relative bg-gradient-to-br from-red-600 via-orange-500 to-yellow-500 rounded-2xl p-1 shadow-2xl">
                  <div className="bg-white rounded-xl p-6 space-y-4">
                    {/* Dashboard Header */}
                    <div className="flex items-center justify-between pb-4 border-b">
                      <div className="flex items-center gap-3">
                        <img src="/pisairtel-logo.svg" alt="Logo" className="w-10 h-10 rounded-lg object-contain" />
                        <div>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <div className="bg-gradient-to-br from-red-50 to-orange-100 rounded-lg p-3 border border-red-200">
                    ...
                    <div className="grid grid-cols-3 gap-2">
                      ...
                      <button className="p-2 bg-orange-50 hover:bg-orange-100 rounded-lg transition-colors">
                ...
                {/* Glow Effect */}
                <div className="absolute inset-0 bg-gradient-to-br from-red-400 to-orange-500 rounded-2xl blur-2xl opacity-20 -z-10"></div>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <Card key={index} className="border-2 hover:border-red-500 transition-all hover:shadow-lg">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <Card className="bg-rose-50 border-none">
                <CardContent className="p-6">
                  <p className="text-4xl font-bold text-rose-600 mb-2">100K+</p>
